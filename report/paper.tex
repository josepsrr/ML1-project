...
The pipeline is fully reproducible from one command: \texttt{python project.py}. The code produces tables, figures, and a JSON summary in the \texttt{outputs/} directory.
