...
The pipeline is fully reproducible from two commands: \texttt{python scripts/download\_data.py} and \texttt{python scripts/run\_pipeline.py}. The code produces tables, figures, and a JSON summary in the \texttt{outputs/} directory.
...
\label{tab:metrics}
\input{../outputs/tables/model_metrics.tex}
\end{table}
...
\label{tab:reg}
\input{../outputs/tables/interaction_regression_key_terms.tex}
\end{table}

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{../outputs/figures/disclosure_by_seller.png}
\caption{Disclosure index by seller type}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{../outputs/figures/residuals_by_disclosure_quintile.png}
\caption{Average baseline residual by disclosure quintile}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{../outputs/figures/top_price_terms.png}
